    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          ...
          <!-- 小图列表 -->
          <!-- <ImageList @currentChange="currentChange"/> -->
            ...
            <div class="chooseArea">
              ...
              <dl v-for="attr in spuSaleAttrList" :key="attr.id">
                ...
                v-for="val in attr.spuSaleAttrValueList" :key="val.id"
                 @click="selectChoose(val,attr.spuSaleAttrValueList)"
                 :class="{active: val.isChecked === '1'}">{{val.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
  ...
  export default {
    ...
    methods:{
      ...
      async addToCart(){
        ...
        // dispatch的返回值是一个promise，就是异步action执行返回的promise
        // this.$store.dispatch("addToCart",{skuNum,skuId})
        // .then((value) => {
        ...
        // })
        try {
          // 将商品信息d json文本保存到sessionStorage中
          sessionStorage.setItem("skuInfo",JSON.stringify(this.skuInfo))
          await this.$store.dispatch("addToCart",{skuNum,skuId})
          // 携带skuNum的query参数
